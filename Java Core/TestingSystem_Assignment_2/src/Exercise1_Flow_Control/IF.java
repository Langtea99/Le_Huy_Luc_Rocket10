...
//			người hóng chuyện, tham gia tất cả các group"
		if(groupOfAccount2 == null || groupOfAccount2.length == 0){
			...
			System.out.println("Group của nhân viên này là :" + groupOfAccount2[0].groupName +" and " + groupOfAccount2[1].groupName);
		}else if(groupOfAccount2.length == 3){
			System.out.println("Nhân viên này là người quan trọng, tham gia nhiều group");
		}else if(groupOfAccount2.length == 4){
			System.out.println("Nhân viên này là người người hóng chuyện, tham gia tất cả các group");
		}
//		Question 3:
