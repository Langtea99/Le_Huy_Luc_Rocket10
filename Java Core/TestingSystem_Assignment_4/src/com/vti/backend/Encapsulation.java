...
public class Encapsulation {
	// Question 1:
		...
		public void question1() {
			Student student1 = new Student("Lực", "Nam Định");
			student1.setAcademic_grade(8);;

			Student student2 = new Student("Lực", "Nam Định");
			student2.setAcademic_grade(9);;

			Student student3 = new Student("Lực", "Nam Định");
			student3.setAcademic_grade(8.5f);
			student3.plus_Academic_grade(8);;
